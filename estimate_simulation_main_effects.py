...
## Save output
np.save('simulation_main/estimation'+str(n)+'/loglik_ga.npy', max_lik_ga); np.save('simulation_main/estimation'+str(n)+'/loglik_em.npy', max_lik_em)
np.save('simulation_main/estimation'+str(n)+'/ks_score_ga.npy', ks_score_ga); np.save('simulation_main/estimation'+str(n)+'/ks_score_em.npy', ks_score_em)
np.save('simulation_main/estimation'+str(n)+'/ks_pval_ga.npy', ks_pval_ga); np.save('simulation_main/estimation'+str(n)+'/ks_pval_em.npy', ks_pval_em)
np.save('simulation_main/estimation'+str(n)+'/alpha_ga.npy', alpha_ga); np.save('simulation_main/estimation'+str(n)+'/alpha_em.npy', alpha_em)
np.save('simulation_main/estimation'+str(n)+'/beta_ga.npy', beta_ga); np.save('simulation_main/estimation'+str(n)+'/beta_em.npy', beta_em)
np.save('simulation_main/estimation'+str(n)+'/mu_ga.npy', mu_ga); np.save('simulation_main/estimation'+str(n)+'/mu_em.npy', mu_em)
np.save('simulation_main/estimation'+str(n)+'/mu_prime_ga.npy', mu_prime_ga); np.save('simulation_main/estimation'+str(n)+'/mu_prime_em.npy', mu_prime_em)
np.save('simulation_main/estimation'+str(n)+'/phi_ga.npy', phi_ga); np.save('simulation_main/estimation'+str(n)+'/phi_em.npy', phi_em)
np.save('simulation_main/estimation'+str(n)+'/phi_prime_ga.npy', phi_prime_ga); np.save('simulation_main/estimation'+str(n)+'/phi_prime_em.npy', phi_prime_em)